...
namespace Kowalsky.Services
{
    public class EmailTemplateService : IEmailTemplateService
    {
        public (string subject, string body) CreateConfirmationEmailTemplate(ContactInfo contactInfo)
        {
            ...
            sb.Append(
                "<p>Köszönjük, hogy megtisztelt a bizalmával. Rövid időn belül jelentkezni fogunk az alábbi elérhetőségeken:<p>");

            sb.Append($"<p>E-mail cím: {contactInfo.Email}</p>");
            sb.Append($"<p>Telefon: {contactInfo.Phone}</p>");
            sb.Append("<p>Amennyiben a válaszunkra nem tud várni, kérem hívja a 0630 970 6890-es számot. </p>");
